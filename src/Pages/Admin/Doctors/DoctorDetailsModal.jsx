        ...
        <table className="w-full text-left border border-gray-200">
          <thead>
            <tr className="uppercase text-sm leading-normal">
              <th className="py-2 border-b-[2px] border-b-black w-[40%] text-left text-[13px]">
                Fields
              </th>
            ...
            {doctorDetails ? (
              <>
                <tr className="text-sm w-full">
                  <td className="py-2 border-t-[1px] font-bold w-[50 %] ml-4">
                    Name
                  </td>
                  <td className="py-2 border-t-[1px] text-[12px] w-[50%] ml-4">
                    {doctorDetails.name}
                  </td>
                </tr>
                <tr className="text-sm w-full">
