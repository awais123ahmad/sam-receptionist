...
import AddOrderReturn from './AddOrderReturn'
  ...
  return (
    <div>
      ...
      {response.loading ?
        ...
        <>
          {response.noData ?
            <DataNotFound title={"No Order Return Found"} button={"+ Add Order Return"} />
            :

            <div className="p-4">
              <ListHead
                title={"Order Return Table"}
                records={response.categories.length}
                buttonText={"+ Add Order Return"}
                searchData={search}
                ...
                <table className="w-[100%] ">
                  <thead className="">
                    <tr className=" text-[#101418] capitalize leading-normal w-[100%] ">
                      <th className="py-[1%] w-[10%] text-[.8rem] text-gray-700 text-left pl-4">No.</th>
                  ...
                  {data.map((value, index) => (
                    <tbody key={index} className="text-gray-600 text-sm font-light w-[100%] border-t-[1px] border-gray-200">
                      <tr className={` bg-white  `}>
                        <td className="py-[1%] w-[10%] max-md:text-[.7rem] text-left pl-4">
                        ...
                        <td className=" w-[20%] max-md:text-[.7rem] text-center">
                          <p className="font-[600] text-gray-600 text-[14px]">{value.categoryName}</p>
                        </td>
