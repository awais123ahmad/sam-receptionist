...
// import recordService from "../../../Services/recordService"; // Assuming this fetches patient data
...
//   return (
//     <div className="p-4">
//       <h1 className="ml-[3%] text-[19px] text-gray-700 font-[700]">Sale Medicine</h1>
...
//             />
//             <SearchIcon className="text-gray-700 ml-2 cursor-pointer absolute top-2 right-2" onClick={handleSearch} />
//           </div>
//         </div>
//       </div>
...
//   const [patient, setPatient] = useState(null);
//   const [loading, setLoading] = useState(false);
//   const [medicines, setMedicines] = useState([{ name: "", quantity: "" }]); // State to manage medicines
...
//   // Handle change in medicine input fields
...
//       {/* Medicines Section */}
//       <div className="mt-4 p-4 bg-white shadow-md rounded-lg border border-gray-300">
//         <h3 className="text-lg font-semibold text-gray-700 mb-4">Medicines</h3>
