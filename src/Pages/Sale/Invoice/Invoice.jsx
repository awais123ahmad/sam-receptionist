  ...
  return (
    <div>
      ...
      {response.loading ?
        ...
        <>
          {response.noData ?
            <DataNotFound title={"No Invoice Found"} button={"+ Add Invoice"} />
            :
                ...
                <table className="w-[100%] ">
                  <thead className="">
                    <tr className=" text-[#101418] capitalize leading-normal w-[100%] ">
                      <th className="py-[1%] w-[15%] text-[.8rem] text-gray-700 text-left pl-2">Invoice No.</th>
                      ...
                      <th className="py-[1%] w-[17%] text-[.8rem] text-gray-700 text-center">
                        Due Date
                        <Tooltip title={`Change Order`} placement="bottom">
                          <span onClick={() => toggleSortOrder('date')} className="ml-2 cursor-pointer">
                            <ImportExportIcon sx={{ fontSize: 17 }} />
