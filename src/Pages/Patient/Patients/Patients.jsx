...
const Patients = (patient) => {
  ...
  const handleViewClick = () => {
    // Ensure `patient.patient_id` is defined
    if (patient?.patient_id) {
      navigate("/receptionist", { state: { id: patient.patient_id } });
    } else {
          ...
          <table className="w-[100%]">
            <thead>
              <tr className="capitalize leading-normal text-white">
                <th className="py-[2%] w-[10%] text-[.8rem] text-left pl-4">
                  Patient NO.
                </th>
                <th className="py-[2%] w-[20%] text-[.8rem] text-left pl-4">
                  Check up Date
                </th>
                <th className="py-[2%] w-[20%] text-[.8rem] text-left pl-4">
                  Patient Name
                </th>
                <th className="py-[2%] w-[10%] text-[.8rem] text-left">
                  Contact Number
                </th>
                <th className="py-[2%] w-[10%] text-[.8rem] text-center">
                  CNIC
                </th>
                <th className="py-[2%] w-[20%] text-[.8rem] text-center">
                  Address
                </th>
                <th className="py-[2%] w-[10%] text-[.8rem] text-center">
                  Action
              ...
              {paginatedData.map((patient) => (
                ...
                >
                  ...
                  <td className="w-[20%] text-left">
                    <p className="font-[600] text-gray-600 text-[14px] text-left px-4">
                  ...
                  <td className="py-[2%] w-[10%] text-center">
                    <Link to={`/receptionist/${patient.patient_id}`}>
...
//                         state: { patient_id: patient.patient_id } // Passing the patient_id as state
//                       }}
//                     >
//                       <button className="text-[13px] font-[500] text-blue-500">View</button>
//                     </Link>
